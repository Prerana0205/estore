    ...
    <div class="card-body">
      <form method="post" action="{{route('product.update',$product->id)}}">
        ...
        <div class="form-group">
          ...
          <input id="quantity" type="number" name="quantity" placeholder="Enter quantity"  value="{{$product->quantity}}" class="form-control">
          @error('title')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        ...
        <div class="form-group">
         ...
         <select name="unit" class="form-control">
              ...
              <option value="caps"{{(($product->unit=='caps')? 'selected' : '')}}>caps</option>
              <option value="sachets"{{(($product->unit=='sachets')? 'selected' : '')}}>sachets</option>
