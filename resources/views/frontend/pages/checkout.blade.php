    ...
    <script>
        $(document).ready(function() {
            $('input[name=payment_method]').change(function() {
                ...
                // Set the form action based on the selected payment method
                if (paymentMethod === 'cod') {
                    form.attr('action', "{{ route('home') }}");
                    checkoutBtn.text('proceed to home');
                } else if (paymentMethod === 'razorpay') {
                    form.attr('action', "{{ route('payment.success') }}");
                    checkoutBtn.text('proceed to razorpay');
                }
            });
        });
   </script>
